...
<div class="half">
        ...
        <input class="addEmployee" type="text" name="fname" id="admin_fname" data-name ="fname" placeholder="First Name">
...
<div class="half">
        ...
        <input class="addEmployee" type="text" name="lname" id="admin_lname" data-name ="lname" placeholder="Last Name">
        ...
        <input class="addEmployee" type="text" name="address"  id="admin_address" data-name ="address" placeholder = "Current address">
            ...
            <select name="jobTitle" id="jobTitle" >
                ...
                <option value="Hospital Stuff">Hospital Stuff</option>
