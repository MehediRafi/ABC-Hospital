...
<div class="half">
        ...
        <input class="signup" type="text" name="admin_fname" id="admin_fname" data-name ="fname" placeholder="Mehedi">
        ...
        <input class="signup"  type="tel" id="phone" name="admin_mobileno" data-name ="mobileNo" placeholder="017xxxxxxx">
...
<div class="half">
        ...
        <input class="signup" type="text" name="admin_lname" id="admin_lname" data-name ="lname" placeholder="Rafi">
